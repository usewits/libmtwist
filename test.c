...
static unsigned long const test_seed_54321_results_1[TEST_SET_1_NRESULTS] = {
    ULONG_C(3915467345), ULONG_C(2189234826), ULONG_C(2679307290),
    ULONG_C(787501152),  ULONG_C(3400771556), ULONG_C(3473638550),
    ULONG_C(1845911630), ULONG_C(4027756818), ULONG_C(2332222920),
    ULONG_C(127158527),  ULONG_C(1775789767), ULONG_C(3371479562),
    ULONG_C(367824108),  ULONG_C(703848432),  ULONG_C(3339822589),
    ULONG_C(1863375487), ULONG_C(2100022882), ULONG_C(2466459787),
    ULONG_C(217027622),  ULONG_C(932105407)};
...
static unsigned long const test_seed_54321_results_2[TEST_SET_2_NRESULTS] = {
    ULONG_C(2109020469), ULONG_C(264978304),  ULONG_C(3951898066),
    ULONG_C(3322908472), ULONG_C(2243665931), ULONG_C(3379990241),
    ULONG_C(1427746768), ULONG_C(3217532946)};
...
static unsigned long const test_seed_54321_results_3[TEST_SET_3_NRESULTS] = {
    ULONG_C(4262956485), ULONG_C(2083563531), ULONG_C(1724557607),
    ULONG_C(4100776152), ULONG_C(4050777500), ULONG_C(3146323433),
    ULONG_C(2882918002), ULONG_C(3891093309), ULONG_C(1534503088),
    ULONG_C(1821071197)};
